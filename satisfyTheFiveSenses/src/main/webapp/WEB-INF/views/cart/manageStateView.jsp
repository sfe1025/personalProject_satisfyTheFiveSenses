	...
	<head>
		...
		$(document).ready(function(){
			...
			$("#sendBtn").on("click", function(){
				...
				formObj.attr("action", "/controller/cart/send");
			...
			<input type="text" value="${member.userId}">
				...
				<!-- <form name="cartForm" action="/controller/cart/delete" method="post"> -->
					<c:forEach items="${list}" var = "list">
						<form role="sendForm" method="post" action="/controller/cart/send" enctype="multipart/form-data">
							...
							<button type="submit" id="sendBtn">배송보내기</button>
							</c:if>
 -->				</form>
					</c:forEach>
				<!-- 	</form> -->
